...
def prepare_simple_launcher_cmd_env(args: argparse.Namespace) -> Tuple[List[str], Dict[str, str]]:
    ...
    elif args.gcu_ids != "all" and args.gcu_ids is not None:
        current_env["TOPS_VISIBLE_DEVICES"] = args.gcu_ids
...
class PrepareForLaunch:
    ...
    def __call__(self, index, *args):
        ...
        elif self.distributed_type in (DistributedType.MULTI_GPU, DistributedType.MULTI_CPU, DistributedType.MULTI_GCU):
