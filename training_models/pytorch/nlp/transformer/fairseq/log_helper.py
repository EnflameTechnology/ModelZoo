...
import atexit
import time
from  tops_models import dllogger
from collections import OrderedDict, defaultdict
from tops_models.dllogger import Backend, JSONStreamBackend
...
def setup_logger(args):
    aggregator_dict = OrderedDict([
        ...
        ('nsentences', ('average', 'performance')),
        ('updates', 'performance'),
        ('gnorm','average')
        ])
    ...
    dllogger.metadata('l2_loss', {'unit':'nat', 'GOAL':'MINIMIZE', 'STAGE':'TRAIN'})
    dllogger.metadata('mse_val_loss', {'unit':'nat', 'GOAL':'MINIMIZE', 'STAGE':'VAL'})
