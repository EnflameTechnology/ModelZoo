...
def get_parser(desc):
    ...
    parser.add_argument('--amp-type', type=str, default="torch", help='apex or torch')
    ...
    parser.add_argument('--device_type', type=str, default="cuda", help='cuda cpu or gcu')
    parser.add_argument('--device', type=str, default='0', help='device')
    parser.add_argument('--log-get-freq', type=int, default=20, help='log get freq')
    parser.add_argument('--use_aot', default=False, type=bool, metavar='BOOL',
                        help='use_aot (default: False)')
    return parser
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    parser.add_argument('--left-pad-source', default=False, type=bool, metavar='BOOL',
    ...
    parser.add_argument('--static-batch', default=False, type=bool, metavar='BOOL',
                        help='static input shape (default: False)')
    parser.add_argument('--skip-steps', default=2, type=int, metavar='N',
                            help='skip step when cal fps')
...
def add_distributed_training_args(parser):
    ...
    group.add_argument('--distributed-init-method', default="env://", type=str,
...
def add_optimization_args(parser):
    ...
    group.add_argument('--optimizer', default='adam', metavar='OPT',
                       ...
                       help='optimizer: {} (default: adam)'.format(', '.join(OPTIMIZER_REGISTRY.keys())))
    ...
    group.add_argument('--min-lr', default=0.0, type=float, metavar='LR',
...
def add_common_eval_args(group):
    ...
    group.add_argument('--no-eval', action='store_true',
                       help='no eval during training')
...
def add_model_args(parser):
    ...
    group.add_argument(
        '--arch', '-a', default='transformer_wmt_en_de_base_t2t', metavar='ARCH',
        choices=ARCH_MODEL_REGISTRY.keys(),
        help='model architecture: {} (default: transformer_wmt_en_de_base_t2t)'.format(
