...
def parse_args():
    ...
    parser.add_argument("--weight_decay", default=0.01, type=float,
                        help="Weight decay used for optimizer.")
    parser.add_argument("--drop_last", default=False, action='store_true', help="Whether to drop last sample while training.")
...
def main():
    ...
    if args.do_train:
        ...
        train_dataloader = DataLoader(train_data, sampler=train_sampler, batch_size=args.train_batch_size * n_device, num_workers = args.workers,drop_last=args.drop_last)
        ...
        for epoch in range(int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(train_iter):
                ...
                if (step+1) % args.print_freq == 0:
                    ...
                    logger.info("epoch:{}, step:{}, step_loss:{}, learning_rate:{}, step_fps:{}".format(epoch, step, final_loss, optimizer.param_groups[0]['lr'],train_fps_step))
