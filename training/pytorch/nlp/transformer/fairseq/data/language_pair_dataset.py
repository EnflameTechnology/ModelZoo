...
class LanguagePairDataset(FairseqDataset):
    ...
    def __init__(
        ...
        pad_sequence=1, shuffle=True,static_batch=False,
    ):
        ...
        if self.static_batch:
            assert self.max_source_positions == self.max_target_positions
    ...
    def collater(self, samples):
        ...
        return data_utils.collate(
            ...
            pad_sequence=self.pad_sequence,static_batch=self.static_batch,max_length=self.max_source_positions,
        )
