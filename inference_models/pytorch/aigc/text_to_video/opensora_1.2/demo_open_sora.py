...
def main():
    ...
    model = STDiT3_XL_2(
        ...
        enable_flash_attn=cfg.model["enable_flash_attn"],
        enable_layernorm_kernel=cfg.model["enable_layernorm_kernel"],
    ...
    # == build scheduler ==
    scheduler = RFLOW(
        num_sampling_steps=cfg.scheduler["num_sampling_steps"],
    ...
    print(f'inference time: {time_e} s')
