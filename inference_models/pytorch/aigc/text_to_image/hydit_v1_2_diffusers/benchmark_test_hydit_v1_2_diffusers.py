...
def get_args_parser(add_help=True):
    parser = argparse.ArgumentParser(
        description="hunyuanDit-v1.2-diffusers txt2img benchmark script",
        add_help=add_help,
    )

    parser.add_argument(
        "--model_dir", required=True, type=str, help="root path to hunyuanDit-v1.2-diffusers pretrained models"
    )
...
def bench_hunyuanDiT_v1_2_diffusers_text2image(
    device,
    model_dir,
    image_height,
    image_width,
    ...
    report_path = os.path.join(output_dir, "report-hydit-v1.2-diffusers-txt2img.json")
...
if __name__ == "__main__":
    ...
    bench_hunyuanDiT_v1_2_diffusers_text2image(
        device=args.device,
